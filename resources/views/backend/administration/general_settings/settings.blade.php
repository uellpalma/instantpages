			...
			<div class="kt-portlet__body kt-portlet__body--fit-x">
				<div class="col-12">
					<form method="post" class="appsvan-submit params-panel" autocomplete="off" action="{{ url('administration/general_settings/update') }}" enctype="multipart/form-data">
						...
						{{-- 
						<br>
						<h5 class="header-title">{{ _lang('Billplz') }}</h5>
						<div class="params-panel border border-dark p-3">
							<div class="row">
								<div class="col-md-3">
								<div class="form-group">
									<label class="control-label">{{ _lang('Billplz Active') }}</label>						
									<select class="form-control" name="billplz_active" required>
									<option value="No" {{ get_option('billplz_active') == 'No' ? 'selected' : '' }}>{{ _lang('No') }}</option>
									<option value="Yes" {{ get_option('billplz_active') == 'Yes' ? 'selected' : '' }}>{{ _lang('Yes') }}</option>
									</select>
								</div>
								</div>
								...
								<div class="col-md-3">
								<div class="form-group">
									<label class="control-label">{{ _lang('Billplz XSignature Key') }}</label>						
									<input type="text" class="form-control" name="billplz_xsignature_key" value="{{ get_option('billplz_xsignature_key') }}">
								</div>
								</div>
								
								<div class="col-md-3">
								<div class="form-group">
									<label class="control-label">{{ _lang('Billplz Secret Key') }}</label>						
									<input type="text" class="form-control" name="billplz_secret_key" value="{{ get_option('billplz_secret_key') }}">
								</div>
								</div>
								...
								<div class="col-md-3">
								<div class="form-group">
									<label class="control-label">{{ _lang('Billplz Currency') }}</label>						
									<select class="form-control select2 auto-select" data-selected="{{ get_option('billplz_currency','MYR') }}" name="billplz_currency" id="billplz_currency" required>
										<option value="MYR">{{ _lang('Malaysia') }}</option>
									</select>
								</div>
								</div>
						...
						<br>
						<h5 class="header-title">{{ _lang('Paddle') }}</h5>
						<div class="params-panel border border-dark p-3">
							<div class="row">
								<div class="col-md-3">
								<div class="form-group">
									<label class="control-label">{{ _lang('Paddle Active') }}</label>						
									<select class="form-control" name="paddle_active" required>
									<option value="No" {{ get_option('paddle_active') == 'No' ? 'selected' : '' }}>{{ _lang('No') }}</option>
									<option value="Yes" {{ get_option('paddle_active') == 'Yes' ? 'selected' : '' }}>{{ _lang('Yes') }}</option>
									</select>
								</div>
								</div>
								...
								<div class="col-md-3">
								<div class="form-group">
									<label class="control-label">{{ _lang('Paddle Vendor Auth Code') }}</label>						
									<input type="text" class="form-control" name="PADDLE_VENDOR_AUTH_CODE" value="{{ get_option('PADDLE_VENDOR_AUTH_CODE') }}">
								</div>
								</div>
								
								<div class="col-md-3">
								<div class="form-group">PUBLIC KEY
									<label class="control-label">{{ _lang('Paddle Public Key') }}</label>						
									<input type="text" class="form-control" name="PADDLE_PUBLIC_KEY" value="{{ get_option('PADDLE_PUBLIC_KEY') }}">
								</div>
								</div>

								<div class="col-md-3">
								<div class="form-group">
									<label class="control-label">{{ _lang('Vendor ID') }}</label>						
									<input type="text" class="form-control" name="PADDLE_VENDOR_ID" value="{{ get_option('PADDLE_VENDOR_ID') }}">
								</div>
								</div>
								...
								<div class="col-md-3">
								<div class="form-group">
									<label class="control-label">{{ _lang('Paddle Currency') }}</label>						
									<select class="form-control select2 auto-select" data-selected="{{ get_option('paddle_currency','USD') }}" name="paddle_currency" id="paddle_currency" required>
										<option value="MYR">{{ _lang('Dollar') }}</option>
									</select>
								</div>
								</div>
