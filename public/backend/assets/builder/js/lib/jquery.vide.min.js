! function(e, t) {
    ...
    function i(e, t, o) {
        if (this.$element = g(e), "string" == typeof t && (t = r(t)), o ? "string" == typeof o && (o = r(o)) : o = {}, "string" == typeof t) t = t.replace(/\.\w*$/, "");
            ...
            for (var i in t) 
            var ex = Object.keys(t)[0].split('.').pop();
                if(t[i] == t.ex) {
                    t.hasOwnProperty(i) && (t.mp4 = t.mp4.replace(/\.\w*$/, ""));
                } 
    ...
    i.prototype.init = function() {
        ...
        t = r.$wrapper = g("<div>").addClass(d.className).css({
            ...
            i(this.src)
        }, g('<img src="' + (o = a) + '.gif">').on("load", n), g('<img src="' + o + '.jpg">').on("load", n), g('<img src="' + o + '.jpeg">').on("load", n), g('<img src="' + o + '.png">').on("load", n)) : "none" !== l && t.css("background-image", "url(" + a + "." + l + ")"), "static" === c.css("position") && c.css("position", "relative"), c.prepend(t), "object" == typeof s ? (s.mp4 && (p += '<source src="' + s.mp4 + '.mp4" type="video/mp4">'), s.webm && (p += '<source src="' + s.webm + '.webm" type="video/webm">'), s.ogv && (p += '<source src="' + s.ogv + '.ogv" type="video/ogg">'), e = r.$video = g("<video>" + p + "</video>")) : e = r.$video = g('<video><source src="' + s + '.mp4" type="video/mp4"><source src="' + s + '.webm" type="video/webm"><source src="' + s + '.ogv" type="video/ogg"></video>');
        try {
            e.prop({
                autoplay: d.autoplay,
                loop: d.loop,
