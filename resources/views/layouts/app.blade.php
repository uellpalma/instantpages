                                ...
                                <ul class="kt-menu__nav ">
                                    <li class="kt-menu__item">
                                        <a  href="{{url('/')}}" target="_blank" class="kt-menu__link kt-menu__time">
																					...
																					<span class="kt-menu__link-text">{{ _lang('Website') }}</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
