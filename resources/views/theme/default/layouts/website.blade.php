...
<head>
  ...
  <link href="{{ asset('public/theme/default/assets/css/theme-rtl.css') }}" rel="stylesheet" type="text/css"
    media="all" />
  @else
  <link href="{{ asset('public/theme/default/assets/css/theme.css') }}" rel="stylesheet" type="text/css" media="all" />
  @endif
          ...
          <div class="col-md-6 col-lg-5 mt-0">
            ...
            <a class="btn btn--primary type--uppercase"
              ...
              <span class="btn__text">
                ...
                {{ _lang('Start') . ' ' . get_option('trial_period') . ' ' . _lang('Days Trial') }} @else
                {{ _lang('Get Started') }} @endif
              </span>
            </a>
